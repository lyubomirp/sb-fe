...
const GrayKnights: React.FC<Svg> = ({ className }) => {
  return (
    <svg
    ...
    >
      <g
        id="g12"
        transform="matrix(0.80988054,0,0,0.80988054,-175.42012,-4.8592832)"
      >
        <polygon
          points="241.6,369 216.6,369 216.6,816 782.6,816 782.6,369 757,369 757,796 241.6,796 "
          id="polygon2"
        />
        <path
        ...
        />
        <path
          d="m 492.1,449 h -30 V 351.9 C 388,356.5 322,354.2 259.1,349 v 430 c 77.6,3.4 155.3,5.2 233,5.3 z"
          id="path8"
        />
        <path
          d="m 537.1,449 h -30 v 335.3 c 77.6,-0.1 155.3,-1.9 233,-5.3 V 349 c -58.1,7.8 -127.7,7.3 -203,2.6 z"
          id="path10"
        />
      </g>
    </svg>
